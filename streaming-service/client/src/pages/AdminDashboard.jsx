...
export default function AdminDashboard() {
  return (
    <div>
      ...
      <div className="railHead" style={{ marginTop: 18 }}>
        <h2 className="railTitle"><i className="bi bi-music-note"></i> Music</h2>
        <div className="railHint">Review user-submitted tracks</div>
      </div>

      <div className="rail">
        <Link to="/admin/music" className="tile">
          <div className="tilePoster" />
          <div className="tileBody">
            <div className="tileTitle"><i className="bi bi-headphones"></i> Music Uploads</div>
            <div className="tileMeta">
              <span className="badge">Moderate</span>
              <span className="subtle">User submissions</span>
            </div>
          </div>
        </Link>
      </div>
      ...
      <div className="railHead" style={{ marginTop: 18 }}>
        <h2 className="railTitle">👥 User Management</h2>
        <div className="railHint">Manage user accounts and permissions</div>
      </div>
      ...
      <div className="rail">
        <Link to="/admin/users" className="tile">
          <div className="tilePoster" />
          <div className="tileBody">
            <div className="tileTitle"><i className="bi bi-people"></i> All Users</div>
            <div className="tileMeta">
              <span className="badge">Manage</span>
              <span className="subtle">View and manage users</span>
            </div>
          </div>
        </Link>
      </div>
